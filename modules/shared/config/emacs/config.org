...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "qiaoborui"
    user-mail-address "Mr.Strawberry@outlook.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/qiaoborui/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/qiaoborui/bin" "/profile/bin" "/Users/qiaoborui/.npm-packages/bin" "/Users/qiaoborui/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
